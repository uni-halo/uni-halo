...
import type { DataLoadingStatus } from './useDataLoadingStatus';
 ...
 */
export function useDataLoading<T, P extends unknown[] = []>(fetcher: (...args: P) => Promise<T>, options: IUseDataLoadingOptions<T> = {}): IUseDataLoadingReturn<T, P> {
