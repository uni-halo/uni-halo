...
export const DefaultQuickNavigation: IQuickNavItem[] = [
  ...
  { key: 'favorites', title: '我的收藏', subTitle: '文章和瞬间收藏', color: '#FFB300', bgColor: '#FFB30024', iconPrefix: 'uhemoji2-icon', icon: '-smiling', path: '/pages-blog/favorites/favorites', visible: true },
