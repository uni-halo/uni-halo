      ...
      <scroll-view :scroll-x="true" :show-scrollbar="false" class="w-full whitespace-nowrap">
        ...
        >
          ...
          <template v-if="f.key !== 'status'">
            <wd-icon
              v-if="f.key === 'sort' && filterValues.sort !== 'default'"
      ...
      <view v-if="filterPopup.item" class="box-border p-4">
        ...
        <view class="flex flex-col gap-2">
          <view
            ...
            class="uh-global-card-glass box-border border rounded-xl px-5 py-2 text-center text-sm shadow-none"
        ...
        <template v-if="filterPopup.item.key === 'sort'">
          ...
          <view class="flex gap-2">
            <view
              v-for="dir in sortDirOptions" :key="dir.value"
              class="uh-global-card-glass box-border flex-1 border rounded-xl px-5 py-2 text-center text-sm shadow-none"
