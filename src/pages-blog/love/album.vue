...
<template>
	<view class="app-page box-border min-h-screen w-screen flex flex-col pb-safe">
		...
		<uh-unlock-popup v-if="currentUnlockAlbum" v-model:show="showUnlockModal" title="解锁相册" captcha-enabled
		...
		<!-- 相册图片查看弹窗(数据在组件内部自请求) -->
		<uh-album-photo-viewer v-if="currentViewerAlbum" v-model="showPhotoViewer" :show="showPhotoViewer"
