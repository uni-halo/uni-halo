...
<template>
	<view class="box-border min-h-screen bg-page p-3 pt-2">
		...
		<uh-data-loading v-if="!agreementContent" :loading-status="DataLoadingStatusEnum.Empty" min-height="80vh"
		...
		<view v-else class="w-full h-full uh-global-card-glass uh-shadow-xs rounded-xl text-3xs text-gray-900">
			<mp-html :content="agreementContent" lazy-load :domain="markdownConfig.domain"
