...
<template>
  ...
  <view class="box-border min-h-screen bg-page">
    ...
    <view class="box-border flex flex-col gap-y-5 px-4 py-3">
      <!-- 头像卡片 -->
      <view
        class="uh-global-card-glass uh-shadow-xs flex flex-col items-center gap-y-2 rounded-2xl py-6"
        @click="chooseAvatar"
      >
        <view class="relative">
          <image
          ...
          />
          <view
            class="uh-global-card-glass absolute bottom-0 right-0 h-7 w-7 flex items-center justify-center border rounded-full"
          >
      ...
      <view class="flex flex-col">
        ...
        <view class="uh-global-card-glass uh-shadow-xs mt-3 overflow-hidden rounded-2xl">
          <!-- 昵称(整行可点进编辑) -->
          <view
            class="flex items-center gap-x-3 px-4 py-3.5"
          ...
          >
            ...
            <view class="flex flex-1 items-center justify-end gap-x-2">
              <template v-if="editingNickname">
                <wd-input
                  v-model="nicknameDraft" no-border custom-class="uh-profile-input" focus
                ...
                <text
                  class="shrink-0 text-sm text-gray-900"
          ...
          <view class="flex items-center gap-x-3 border-b border-black/5 px-4 py-3.5">
            ...
            <view class="flex flex-1 items-center justify-end">
              <text
                class="rounded-full bg-secondary px-2 py-0.5 text-20rpx text-[#4d7c0f]"
              >
                {{ isAdmin ? '超级管理员' : '普通用户' }}
              </text>
            </view>
    ...
    >
      ...
      <view class="w-full box-border flex flex-col gap-y-3 p-3">
        ...
        <view class="flex flex-col gap-y-3">
          ...
          />
          <wd-input
            v-model="confirmPassword" custom-class="uh-profile-input" show-password
