          ...
          <view class="uh-global-card-glass uh-shadow-xs box-border w-full rounded-2xl p-4">
            ...
            <view class="mt-4 flex items-start justify-center gap-x-1.5 px-2" @click="agreed = !agreed">
              ...
              <view class="text-xs text-black/50 leading-5">
                我已阅读并同意<text
                  class="text-primary"
                  @click.stop="openAgreementPopup('userAgreement')"
                >
                  《用户协议》
                </text>与<text
                  class="text-primary" @click.stop="openAgreementPopup('privacyPolicy')"
                >
                  《隐私政策》
                </text>
              </view>
            ...
            <button
              ...
              class="uh-button-native uh-global-card-glass text-so mt-3 w-full bg-primary text-gray-900 !rounded-full !py-2"
