...
<template>
	<view class="relative box-border min-h-screen w-screen flex flex-col bg-[#f5fae8] overflow-hidden">
		...
		<view class="relative z-10 box-border px-6 w-screen h-screen flex flex-col items-center justify-center gap-y-6">
			<view class="flex-1 w-full box-border pt-26 flex flex-col gap-y-4 items-center justify-center">
					...
					<view class="uh-global-card-glass uh-shadow-xs box-border w-full rounded-2xl p-4">
						...
						<view class="mt-4 flex items-start justify-center gap-x-1.5 px-2" @click="agreed = !agreed">
							...
							<view class="text-xs text-black/50 leading-5">
								我已阅读并同意<text class="text-primary"
									@click.stop="openAgreementPopup('userAgreement')">《用户协议》</text>与<text
									class="text-primary" @click.stop="openAgreementPopup('privacyPolicy')">《隐私政策》</text>
							</view>
						</view>
						...
						<button v-if="wechatLoginEnabled"
							class="uh-button-native mt-3 w-full uh-global-card-glass bg-primary !py-2 !rounded-full text-xs text-gray-900"
			...
			<!-- 页脚 -->
			<view class="shrink-0 relative z-10 box-border pt-4 pb-safe mb-4 w-full">
				<uh-page-copyright />
			</view>
		</view>
