...
<template>
  <view class="relative min-h-screen w-screen flex flex-col justify-center overflow-hidden bg-[#f5fae8]">
    ...
    <!-- 维护页 -->
    <view v-else class="relative z-10 min-h-screen w-full w-full flex flex-col items-center justify-center">
      <view class="relative w-full px-[40rpx] pb-[64rpx] pt-[calc(var(--status-bar-height)+76rpx)] text-center">
        <view
          ...
          >
            ...
            <view class="mt-4 w-full flex justify-center gap-4">
              <view class="flex-1 rounded-[24rpx] bg-[#f4fbe0] px-[8rpx] pb-[16rpx] pt-[18rpx]">
                <text
                  class="block text-[42rpx] text-[#17181a] font-black leading-none tabular-nums"
                >
                  {{ countdownParts.days }}
                </text>
                <text
              ...
              <view class="flex-1 rounded-[24rpx] bg-[#f4fbe0] px-[8rpx] pb-[16rpx] pt-[18rpx]">
                <text
                  class="block text-[42rpx] text-primary font-black leading-none tabular-nums"
                >
