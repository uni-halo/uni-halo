...
<template>
	<view class="relative min-h-screen w-screen flex flex-col justify-center overflow-hidden bg-[#f5fae8]">
		...
		<!-- 维护页 -->
		<view v-else class="relative z-10 flex-1 w-full w-full flex flex-col items-center justify-center">
			<view class="box-border relative w-full px-6 pb-4 pt-[calc(var(--status-bar-height)+76rpx)] text-center">
				<view
		...
		<view class="shrink-0 box-border pb-3">
			<uh-page-copyright></uh-page-copyright>
		</view>
	</view>
</template>
