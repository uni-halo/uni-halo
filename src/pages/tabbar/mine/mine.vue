...
<template>
  <view class="box-border min-h-screen w-screen bg-page pb-2">
    ...
    <view class="relative h-88 w-full bg-cover bg-no-repeat" :style="[calcProfileStyle]">
      <!-- 背景遮罩 -->
      <view class="absolute left-0 top-0 z-0 h-full w-full bg-black/30" style="backdrop-filter:blur(2rpx)"/>
      ...
      <view class="uh-global-card-glass mx-4 overflow-hidden rounded-2xl">
        ...
        >
          <view class="nav-left flex items-center gap-3 py-3">
            ...
            <text
              class="nav-title text-sm text-gray-900"
