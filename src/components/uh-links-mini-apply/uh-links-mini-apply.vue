...
<template>
	<uh-glass-popup v-model="isShow" :z-index="100" position="bottom" :close-on-click-modal="false" custom-class="!border rounded-xl"
			...
			<scroll-view :scroll-y="true" :show-scrollbar="false" class="box-border max-h-[60vh]">
				...
				<view class="w-full flex flex-col gap-y-3">
					...
					<view v-if="captchaSrc" class="captcha-box flex items-center">
						...
						<image :src="captchaSrc" class="captcha-img h-[76rpx] w-[200rpx] shrink-0 rounded-lg"
